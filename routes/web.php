...
use App\Http\Controllers\LoaiSuKienController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::prefix('/sukien')->group(function () {
    #loaisukien
    Route::get('add',  [LoaiSuKienController::class, 'create']);
    Route::post('add',  [LoaiSuKienController::class, 'store']);
